  ...
  <CommonModal ref="modal">
    <template #body>
      <div class="modal-container">
        ...
        <span
          v-if="
            signUpInfo.user.password.length < 6 &&
            signUpInfo.user.password.length
          "
          class="text-red"
          >Minimum 6 characters</span
        >
        <div class="style-text password">Confirm password</div>
        <v-text-field
        ...
        <span
          v-if="
            signUpInfo.user.password !==
              signUpInfo.user.password_confirmation &&
            signUpInfo.user.password.length &&
            signUpInfo.user.password_confirmation.length
          "
          class="text-red"
        ...
        <div class="sign-up-btn">
          <v-btn
            :disabled="
              signUpInfo.user.password.length < 6 ||
              signUpInfo.user.password !== signUpInfo.user.password_confirmation
            "
            class="bg-primary"
            variant="outlined"
            @click="signUp"
          ...
          <v-btn class="ml-2" @click="login"> Login </v-btn>
        </div>
      </div>
    </template>
  </CommonModal>
